...
-- CHANGE MASTER TO MASTER_LOG_FILE='LAPTOP-QBERAHK2-bin.000010', MASTER_LOG_POS=155;
...
CREATE TABLE `medicalhistory` (
  ...
  `predicteddisease` varchar(255) DEFAULT NULL,
  `consultdoctor` varchar(255) DEFAULT NULL
